...
def oob_admin_panel() -> rx.Component:
    """Admin UI for OOB (no layout wrapper).

    This is used both as a standalone page and as a tab inside `/apps/oob`.
    """
    return rx.vstack(
        ...
        rx.box(
            rx.foreach(
                ...
                lambda vendor: rx.hstack(
                    rx.checkbox(
                        is_checked=vendor["id"] in OOBAccessState.selected_vendor_ids,
